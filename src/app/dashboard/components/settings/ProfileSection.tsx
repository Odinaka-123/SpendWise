...
export default function ProfileSection({
  ...
  return (
    <div className="bg-white border border-[#f0f0ee] rounded-2xl p-5 space-y-4">
      <p className="text-sm font-semibold text-[#0a1a14]">Profile</p>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-sm font-medium text-[#0a1a14]">{form.name}</p>
          <p className="text-xs text-[#9ca3af]">{form.email}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-medium text-[#0a1a14]">Email</label>
          <input
            type="email"
            value={form.email}
